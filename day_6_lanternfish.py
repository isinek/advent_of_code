...
lanternfish, while another might have 4. So, you can model each fish as a single
...
def day_6_task_1():
	fishes = []
	with open('day_6_lanternfish.in') as f:
