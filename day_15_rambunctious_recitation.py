...
most recently spoken before then (turn 1). Thus, the 5th number spoken
is 4 - 1, 3.
...
'''
def day_15_task_1():
	with open('day_15_rambunctious_recitation.in') as f:
		history = [int(x) for x in f.readline().strip('\n').split(',')]
