...
'''
def non_valid_xmas(preamble, data):
...
def day_9_task_1():
	with open('day_9_encoding_error.in') as f:
		data = [int(line) for line in f.readlines()]

	print(non_valid_xmas(25, data))
...
'''
def xmas_weakness(data, non_valid):
...
def day_9_task_2():
	...
	non_valid = non_valid_xmas(25, data)
	print(xmas_weakness(data, non_valid))
